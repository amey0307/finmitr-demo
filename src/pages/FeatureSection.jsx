    ...
    return (
        <section className='md:px-[20vw] px-4 py-10'>
            <div className='grid grid-cols-10 grid-row-2 gap-10'>
                <div className='col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] rounded-3xl drop-shadow-purple sm:h-[25vh] lg:min-h-[30rem] md:h-[30rem] min-h-[13rem] shadow-[0_0px_20px_-3px_#861d51a4] hover:shadow-[0_0px_50px_-20px_#861d51a4] transition-all ease-linear'>
                ...
                <div className='md:col-span-4 col-span-5 lg:p-10 md:p-4 md:py-[5rem] p-4 bg-[#716f6f16] rounded-3xl drop-shadow-purple sm:h-[25vh] lg:min-h-[30rem] md:h-fit min-h-[13rem] shadow-[0_0px_20px_-3px_#861d51a4] hover:shadow-[0_0px_50px_-20px_#861d51a4] transition-all ease-linear'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
                        <img src={bank} alt="" className='h-3 w-3 md:h-10 md:w-10' />
                        <h1 className='md:text-lg lg:text-3xl text-xs'>Unified Finance Hub</h1>
                    </div>
                ...
                <div className='md:col-span-6 col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] rounded-3xl drop-shadow-purple sm:h-[25vh] lg:min-h-[30rem] md:h-[30rem] min-h-[13rem] shadow-[0_0px_20px_-3px_#861d51a4] hover:shadow-[0_0px_50px_-20px_#861d51a4] transition-all ease-linear'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
                        <img src={bank} alt="" className='h-3 w-3 md:h-10 md:w-10' />
                        <h1 className='md:text-lg lg:text-3xl text-xs'>Unified Finance Hub</h1>
                    </div>
