    ...
    return (
        <section className='md:px-[20vw] px-4 py-10'>
            <div className='grid grid-cols-10 grid-row-2 md:gap-10 gap-4'>
                <div value="-1" className='col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] sm:h-[25vh] lg:min-h-[30rem] md:h-[30rem] min-h-[13rem] shadow-[-0.5px_-0.5px_2px_-0.7px_#fff] transition-all ease-linear box'>
                ...
                <div value="-2" className='col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] sm:h-[25vh] lg:min-h-[30rem] md:h-[30rem] min-h-[13rem] shadow-[-0.5px_-0.5px_2px_-0.7px_#fff] transition-all ease-linear box'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
                ...
                <div value="3" className='md:col-span-4 col-span-5 lg:p-10 lg:pt-[5rem] md:p-4 md:py-[5rem] p-4 bg-[#716f6f16] sm:h-[25vh] lg:min-h-[30rem] md:h-fit min-h-[13rem] shadow-[-0.5px_-0.5px_2px_-0.7px_#fff] transition-all ease-linear box'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
                ...
                <div value="1" className='md:col-span-6 col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] sm:h-[25vh] lg:min-h-[30rem] md:h-full min-h-[13rem] shadow-[-0.5px_-0.5px_2px_-0.7px_#fff] transition-all ease-linear box'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
