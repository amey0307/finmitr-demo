...
function FeatureSection() {
    ...
    return (
        <section className='md:px-[20vw] px-4 py-10'>
            <div className='grid grid-cols-10 grid-row-2 md:gap-10 gap-4'>
                <div value="-1" className='col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] rounded-3xl drop-shadow-purple sm:h-[25vh] lg:min-h-[30rem] md:h-[30rem] min-h-[13rem] md:shadow-[0_0px_20px_-3px_#849BEB] shadow-[0_0px_10px_-3px_#849BEB] hover:shadow-[0_0px_30px_-8px_#849BEB] transition-all ease-linear box'>
                ...
                <div value="-2" className='col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] rounded-3xl drop-shadow-purple sm:h-[25vh] lg:min-h-[30rem] md:h-[30rem] min-h-[13rem] md:shadow-[0_0px_20px_-3px_#849BEB] shadow-[0_0px_10px_-3px_#849BEB] hover:shadow-[0_0px_30px_-8px_#849BEB] transition-all ease-linear box'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
                ...
                <div value="3" className='md:col-span-4 col-span-5 lg:p-10 lg:pt-[5rem] md:p-4 md:py-[5rem] p-4 bg-[#716f6f16] rounded-3xl drop-shadow-purple sm:h-[25vh] lg:min-h-[30rem] md:h-fit min-h-[13rem] md:shadow-[0_0px_20px_-3px_#849BEB] shadow-[0_0px_10px_-3px_#849BEB] hover:shadow-[0_0px_30px_-8px_#849BEB] transition-all ease-linear box'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
                ...
                <div value="1" className='md:col-span-6 col-span-5 md:p-10 md:py-[5rem] p-4 bg-[#716f6f16] rounded-3xl drop-shadow-purple sm:h-[25vh] lg:min-h-[30rem] md:h-full min-h-[13rem] md:shadow-[0_0px_20px_-3px_#849BEB] shadow-[0_0px_10px_-3px_#849BEB] hover:shadow-[0_0px_30px_-8px_#849BEB] transition-all ease-linear box'>
                    <div className='flex justify-center items-center md:gap-8 gap-2 md:mb-10 mb-4'>
